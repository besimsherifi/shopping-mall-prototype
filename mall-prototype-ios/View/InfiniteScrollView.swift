...
fileprivate struct InfiniteScrollHelper: UIViewRepresentable {
    ...
    func makeCoordinator() -> Coordinator {
        Coordinator(decalarationRate: declarationRate, contentSize: contentSize)
    }
    ...
    func updateUIView(_ uiView: UIView, context: Context) {
        context.coordinator.decalarationRate = declarationRate
        context.coordinator.contentSize = contentSize
    }
    
    class Coordinator: NSObject, UIScrollViewDelegate {
        var decalarationRate: UIScrollView.DecelerationRate
        var contentSize: CGSize
        init(decalarationRate: UIScrollView.DecelerationRate, contentSize: CGSize) {
            self.decalarationRate = decalarationRate
        ...
        func scrollViewDidScroll(_ scrollView: UIScrollView) {
            scrollView.decelerationRate = decalarationRate
